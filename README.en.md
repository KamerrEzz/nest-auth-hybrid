...
- **Email-based account lockout** — 5 consecutive failures trigger a 15-minute Redis lock, independent of the per-IP rate limit
...
| Account lockout | 5 failures → 15-min Redis lock per email, independent of IP rate limit |
